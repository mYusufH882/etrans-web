  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="/" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bold ms-2">E-Trans</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Barang -->
      <li :class="{ 'menu-item': true, open: isOpen('barang') }">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-box"></i>
          <div class="text-truncate" data-i18n="Basic">Master Barang</div>
        </a>
        <ul class="menu-sub">
          <li :class="{ 'menu-item': true, active: isActive('create-barang') }">
            <a href="/create-barang" class="menu-link">
              <div class="text-truncate">Buat Barang</div>
            </a>
          </li>
          <li :class="{ 'menu-item': true, active: isActive('barang') }">
      ...
      <!-- Customer -->
      <li :class="{ 'menu-item': true, open: isOpen('customer') }">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <ul class="menu-sub">
          ...
          <li :class="{ 'menu-item': true, active: isActive('customer') }">
            <a href="/customer" class="menu-link">
              <div class="text-truncate">Daftar Customer</div>
            </a>
          </li>
        </ul>
      </li>
    ...
    const isActive = (menu) => {
      switch (menu) {
        case 'dashboard':
          return route.path == '/'
        case 'create-barang':
          return route.path == '/create-barang'
        case 'barang':
